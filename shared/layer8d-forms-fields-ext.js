...
*/
/**
 * Layer 8 Form Field Generation - Extended
...
(function() {
    ...
    // desktop and mobile) — this just supplies the desktop-specific escaping
    // helpers and the onclick-embedded namespace name.

    const chips = Layer8FormChips.create({
        escapeHtml,
        escapeAttr,
        namespace: 'Layer8DFormsFields'
    });
    const onTagKeydown = chips.onTagKeydown;
    const removeTag = chips.removeTag;
    const toggleMultiselectDropdown = chips.toggleMultiselectDropdown;
    const onMultiselectChange = chips.onMultiselectChange;
    const removeMultiselectValue = chips.removeMultiselectValue;
