...
(function() {
     ...
     * Delegates to shared Layer8FormatDisplay.
     */
    function getDateZeroLabel(fieldKey) {
        return Layer8FormatDisplay.getDateZeroLabel(fieldKey);
    }

    /**
     * Format a field value for read-only display.
     * Delegates to shared Layer8FormatDisplay.format() — the SINGLE source of truth.
     */
    function formatFieldDisplayValue(field, value) {
        return Layer8FormatDisplay.format(field, value);
    }
    ...
    function generateDateInput(field, value) {
        ...
        return `<div class="date-input-wrapper">
            ...
            <button type="button" class="date-picker-trigger" data-for="field-${field.key}" title="Open calendar"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg></button>
        </div>`;
    }
